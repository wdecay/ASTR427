...
set ylabel "Error, |x_c - x_f|" enhanced
...
plot data1 using (clamp(abs(v1-$1))) with linespoints linestyle 1 title "Bisection",\
     data2 using (clamp(abs(v2-$1))) with linespoints linestyle 2 title "Newton-Raphson"
